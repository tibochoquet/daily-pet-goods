  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-24 text-center">
      ...
      <p className="text-[#6B7280] leading-relaxed mb-2">
        Bedankt voor je bestelling. We nemen binnen 24 uur contact met je op met een betaalverzoek (Tikkie of bankoverschrijving).
      </p>
      <p className="text-[#6B7280] leading-relaxed mb-10">
        Zodra de betaling binnen is, verpakken en verzenden we je bestelling. Vragen? Mail ons op{' '}
