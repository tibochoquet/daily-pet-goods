...
export default function DogPoolsPage() {
  ...
  return (
    <CategoryPage
      ...
      description="Houd jouw hond de hele zomer koel met onze opvouwbare zwembaden en zelfkoelende koelmat. Geen pomp, geen gedoe, gewoon uitvouwen, vullen of neerleggen en genieten. Verkrijgbaar in meerdere maten voor elk ras."
      products={products}
